    ...
    public class ExtendedTinyMceInitialization : IConfigurableModule
    {
        ...
        public void ConfigureContainer(ServiceConfigurationContext context)
        {
            context.Services.Configure<TinyMceConfiguration>(config =>
            {
                ...
                // Add the advanced list styles, table, and code plugins and papend buttons
                // for insterting and editing tables and showing source code to the toolbar
                config.Default()
                    .AddPlugin("advlist table code")
                    .AppendToolbar("table code")
